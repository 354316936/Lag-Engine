...
Initialization* Initialization::instance = 0;
...
void Initialization::PrintToWindow(string message)
{
	Input::ChangeMessage(message);
}

void Initialization::Print(string message)
{
	message += "\n";
	char buf[1000];
...
void Initialization::ErrorExit(const char* lpszFunction)
{
...
void Initialization::ReadCPUSpeed()
{
...
bool Initialization::InitInstance(HINSTANCE _hInstance, HINSTANCE _previousInstance, PSTR _cmdLine, INT _nCmdShow, string _szTitle)
{
...
void Initialization::Run()
{
	RenderSystem rs(hInstance, previousInstance, cmdLine, nCmdShow, szTitle);
	MSG msg;
