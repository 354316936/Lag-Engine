...
bool CheckMemory(const DWORDLONG physicalRAMNeeded, const DWORDLONG virtualRAMNeeded)
{
	...
	{
		// you don韙 have enough virtual memory available. 
	...
	{
		// even though there is enough memory, it isn韙 available in one 
...
bool CheckStorage(const DWORDLONG diskSpaceNeeded)
{
	...
	{
		// if you get here you don韙 have enough disk space!
